...
function Intro() {
  return (
    <section
      id="home"
      className="flex mx-5 md:mx-20 p-4 min-h-[calc(100dvh-64px)] justify-between pt-40 overflow-x-hidden"
    >
      <div className="flex flex-col gap-2 md:gap-5">
        ...
        <p className="text-3xl md:text-5xl text-blue-500">Full Stack Web Developer</p>
        <div className="flex">
        ...
        <div className="flex gap-2">
          <Github onClick={() => (window.location.href = "https://github.com/OnealTorres")} />
          <Linkedin
